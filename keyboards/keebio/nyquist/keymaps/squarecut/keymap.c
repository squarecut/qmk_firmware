...
[_QWERTY] = LAYOUT(
  ...
  KC_GRV,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_CAPS,
  ...
  KC_LCTL, KC_LALT, KC_LGUI, LGUI_T(KC_SPC), LOWER,  LT(RAISE, KC_SPC),  KC_SPC,  KC_SPC,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
